...
def plot_bulk_sc(bulk_df, sc_df, prefix):
    ...
    print("correlation-mu-unfiltered", prefix, stats.pearsonr(merged['mu'], merged['exp']))
    ...
    print("correlation-mean-unfiltered", prefix, stats.pearsonr(merged['mean'], merged['exp']))
