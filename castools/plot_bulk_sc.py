...
def plot_bulk_sc(bulk_df, sc_df, prefix):
    ...
    print("mean")
    print(np.sqrt(reg.score(np.asarray(merged['mean']).reshape(-1, 1), np.asarray(merged['exp']))))
    ...
    print("mu")
    print(np.sqrt(reg.score(np.asarray(merged_filtered['mu']).reshape(-1, 1), np.asarray(merged_filtered['exp']))))
    ...
    print("mean")
    print(np.sqrt(reg.score(np.asarray(merged_filtered['mean']).reshape(-1, 1), np.asarray(merged_filtered['exp']))))
    ...
    print("sum")
    print(np.sqrt(reg.score(np.asarray(merged_filtered['sum']).reshape(-1, 1), np.asarray(merged_filtered['exp']))))
